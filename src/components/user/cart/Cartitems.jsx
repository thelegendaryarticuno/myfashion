...
const CartItems = () => {
    ...
    if (newQuantity >= 1) {
      ...
      try {
        ...
        const response = await fetch(
          "https://myfashion-backend-axwh.onrender.com/cart/update-quantity",
          {
            method: "PUT",
            headers: {
              "Content-Type": "application/json",
  ...
  const handleRemoveItem = async (itemId) => {
    ...
    try {
      const userId = sessionStorage.getItem("userId");
      const response = await fetch(
        "https://myfashion-backend-axwh.onrender.com/cart/delete-items",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleVoucherRedeem = async () => {
    try {
      const response = await fetch(
        "https://myfashion-backend-axwh.onrender.com/coupon/verify-coupon",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
