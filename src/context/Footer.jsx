    ...
    <footer className="bg-black text-white py-12 px-4 md:px-6 lg:px-8">
      <div className="container mx-auto">
        ...
        <div className="mb-12">
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-bold mb-4">Fashion Store</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Men's Product</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Women's Product</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Winter Edition</a></li>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Purpose</a></li>
              </ul>
            </div>
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <p className="text-gray-400 text-sm">© 2023 Fashion Store. All rights reserved.</p>
