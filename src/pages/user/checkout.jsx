...
const Checkout = () => {
  ...
  const fetchCartItems = async () => {
    ...
    try {
      if (userId) {
        ...
        const cartResponse = await fetch(`https://myfashion-backend-axwh.onrender.com/cart/get-cart`, {
          method: 'POST',
          headers: {
        ...
        const productPromises = Object.values(groupedItems).map(async (item) => {
          console.log(item)
          const productResponse = await fetch('https://myfashion-backend-axwh.onrender.com/:productId', {
            method: 'POST',
  ...
  const handlePlaceOrder = async () => {
    ...
    if (saveAddress && userId) {
      try {
        await fetch('https://myfashion-backend-axwh.onrender.com/update-address', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
    ...
    try {
      if (userId) {
        ...
        const response = await fetch('https://myfashion-backend-axwh.onrender.com/cart/place-order', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
